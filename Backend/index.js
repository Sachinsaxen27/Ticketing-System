...
app.use(cors({ origin: 'https://magenta-begonia-83cf73.netlify.app', credentials: true }))
app.options("*",cors({origin: 'https://magenta-begonia-83cf73.netlify.app', credentials: true}))
