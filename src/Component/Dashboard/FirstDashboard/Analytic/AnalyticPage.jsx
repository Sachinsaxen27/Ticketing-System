...
function AnalyticPage() {
  ...
  const GetAverage = async () => {
    const response = await fetch("https://ticketsystem-backend-8vh3.onrender.com/api/messagebox/Conversation_Average", {
      method: "GET",
      headers: {
  ...
  const MissedChat = async () => {
    const response = await fetch("https://ticketsystem-backend-8vh3.onrender.com/api/messagebox/Missed_chat", {
      method: "GET",
      headers: {
        'Content-Type': 'application/json',
      },
