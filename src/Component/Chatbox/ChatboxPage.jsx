...
function ChatboxPage() {
    ...
    const UserInformation = async (e) => {
        ...
        const response = await fetch('https://ticketsystem-backend-6gfl.onrender.com/api/userlogin/get_USERdata', {
            method: 'GET',
            headers: {
    ...
    const GetConversation = async (e) => {
        const response = await fetch(`https://ticketsystem-backend-6gfl.onrender.com/api/messagebox/get_messages/${userInfo._id}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const UserloGin = async (e) => {
        const response = await fetch(`https://ticketsystem-backend-6gfl.onrender.com/api/userlogin/user_login?email=${localStorage.getItem('user-email')}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
    ...
    const handleSumbitfomr = async (e) => {
        e.preventDefault();
        console.log("Hit")
        const response = await fetch('https://ticketsystem-backend-6gfl.onrender.com/api/userlogin/user_signup', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
